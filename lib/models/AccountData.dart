...
class AccountData extends amplify_core.Model {
  ...
  AccountData.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _nutrientGoal = json['nutrientGoal'] != null
        ? NutrientGoal.fromJson(new Map<String, dynamic>.from(json['nutrientGoal']))
        : null,
      ...
      _food = json['food']  is Map
        ? (json['food']['items'] is List
          ? (json['food']['items'] as List)
              .where((e) => e != null)
              .map((e) => MyFood.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['food'] is List
          ? (json['food'] as List)
              ...
              .toList()
          : null),
      _meals = json['meals']  is Map
        ? (json['meals']['items'] is List
          ? (json['meals']['items'] as List)
              .where((e) => e != null)
              .map((e) => MyMeal.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['meals'] is List
          ? (json['meals'] as List)
