...
class Food {
  ...
  Food.fromJson(Map<String, dynamic> json)  
    : _countryCode = json['countryCode'],
      ...
      _nutritionalContents = json['nutritionalContents'] != null
        ? Nutrients.fromJson(new Map<String, dynamic>.from(json['nutritionalContents']))
        : null,
      _servingSizes = json['servingSizes'] is List
        ? (json['servingSizes'] as List)
          .where((e) => e != null)
          .map((e) => ServingSize.fromJson(new Map<String, dynamic>.from(e)))
          .toList()
        : null,
