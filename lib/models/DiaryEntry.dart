...
class DiaryEntry extends amplify_core.Model {
  ...
  const DiaryEntry._internal({required this.id, required title, description, required amount, createdAt, updatedAt}): _title = title, _description = description, _amount = amount, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory DiaryEntry({String? id, required String title, String? description, required double amount}) {
  ...
  DiaryEntry copyWith({String? title, String? description, double? amount}) {
    return DiaryEntry._internal(
      id: id,
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: DiaryEntry.DESCRIPTION,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: DiaryEntry.AMOUNT,
      isRequired: true,
